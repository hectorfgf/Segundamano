...
export class AddArticlePage {
  ...
  createNewAnuncio(form: any){
    this.db.addAnuncio(form.value.categoria, form.value.descripcion, form.value.lugar, form.value.precio, form.value.titulo,this.base64Image,this.user).then(data => {
      if (data){
